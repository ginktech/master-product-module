...
@section('content')
    <div class="d-flex justify-content-between">
        <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
            <div id="table-product-buttons" class="btn-group" role="group"></div>
        ...
        <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
            ...
            <div class="btn-group" role="group" aria-label="Second group">
                <a href="{{ route('master-product.products.create') }}" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i> Create New</a>
            </div>
        </div>
    </div>
    ...
    const tableProduct = $('#table-product').DataTable({
        ...
        columns : [{ 
            ...
            render(data, type, row, meta){
                return `<a class="fw-bolder" href="{{ route('master-product.products.index') }}/${row.id}/edit">${data}</a>`;
            }
        },{
            data : 'name',
            render(data, type, row, meta){
